...
CustomPacket::CustomPacket(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
...
{
    return this->desdeDest;
}

void CustomPacket::setDesdeDest(int desdeDest)
{
    this->desdeDest = desdeDest;
}

int CustomPacket::getNumSeq() const
{
    return this->numSeq;
}

void CustomPacket::setNumSeq(int numSeq)
{
    this->numSeq = numSeq;
}

int CustomPacket::getOrigen() const
{
    return this->origen;
}
...
CustomPacketDescriptor::CustomPacketDescriptor() : omnetpp::cClassDescriptor("CustomPacket", "omnetpp::cPacket")
{
...
bool CustomPacketDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<CustomPacket *>(obj)!=nullptr;
}

const char **CustomPacketDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
const char *CustomPacketDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *CustomPacketDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int CustomPacketDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *CustomPacketDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string CustomPacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool CustomPacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *CustomPacketDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *CustomPacketDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
